...
import { Calculator, TrendingUp, TrendingDown, Target, BarChart3, Moon, Sun, ExternalLink, Grid3x3 } from "lucide-react";
...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-6 right-6 z-50 p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-800 transition-all duration-300 hover:scale-110 shadow-lg"
    >
      {theme === "dark" ? (
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-7xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full max-w-2xl mx-auto grid-cols-4 mb-8 h-16 bg-white dark:bg-slate-900 shadow-xl border border-slate-200 dark:border-slate-800 p-1.5 rounded-2xl" data-testid="calculator-tabs">
            <TabsTrigger 
              value="sip" 
